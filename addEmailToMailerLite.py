...
def add_contact_to_mailerlite_segment(email, name=None, show=None):
    ...
    # API Endpoint
    api_url = f"https://api.mailerlite.com/api/v2/groups/{segment_id}/subscribers"
